...
<template>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4" >
                      <v-text-field v-model="editedItem.customer_id" label="OrderID" ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4" >
                      <v-text-field v-model="editedItem.campaign_id" label="Campaign Id" ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4" >
                      <v-text-field v-model="editedItem.order_source" label="Order Source" ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4" >
  ...
  <script> 
        //import { OrderService } from '../services/customer.service.js';
